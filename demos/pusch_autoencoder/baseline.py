...
The script runs simulations for multiple BS antenna configurations (16 and 32).
...
for num_bs_ant in NUM_BS_ANT_VALUES:
    ...
    for perf_csi in [True, False]:
        ...
        bler_list.append(
            bler_i.numpy() if hasattr(bler_i, "numpy") else np.asarray(bler_i)
        )
...
print("\n" + "=" * 60)
print("Baseline simulations complete for all antenna configurations.")
print("=" * 60)
